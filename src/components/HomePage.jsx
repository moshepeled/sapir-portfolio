      ...
      <div className="home-page__container">
        ...
        <footer className="home-page__footer">
          <div className="home-page__social">
            <a href="https://www.linkedin.com/in/sapir-peled-31726033a/" target="_blank" rel="noopener noreferrer" className="home-page__social-link" aria-label="LinkedIn">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="home-page__social-link" aria-label="Instagram">
              <svg className="home-page__social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="mailto:sapirosh26@gmail.com" className="home-page__social-link" aria-label="Email">
              <svg className="home-page__social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
              </svg>
            </a>
            <a href="https://wa.me/972543141913" target="_blank" rel="noopener noreferrer" className="home-page__social-link" aria-label="WhatsApp">
              <svg className="home-page__social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
